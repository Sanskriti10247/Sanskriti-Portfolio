  ...
  return (
    <section
      ...
      className="h-screen flex flex-col md:flex-row justify-center items-center 
                 bg-gradient-to-br from-gray-950 via-black to-gray-950 text-white relative overflow-hidden px-6"
    >
      ...
      <div className="z-10 max-w-3xl space-y-6 text-center">
        <motion.h2
          ...
          className="text-6xl md:text-8xl font-extrabold leading-tight whitespace-nowrap"
        >
        ...
        <motion.h3
          ...
          className="text-3xl md:text-4xl font-semibold text-gray-300 mt-4 text-center"
        >
          <Typewriter
            words={[
      ...
      <motion.div
        ...
        className="w-[380px] md:w-[520px] mt-10 md:mt-0 md:ml-20"
      >
